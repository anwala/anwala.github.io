...
#path='/home/david/Documents/cs532/assignment6_draft/ml-100k'
# Get movie titles
#movies = {}
...
def loadMovieLens(path='/home/david/Documents/cs532/assignment6_draft/ml-100k'):
  # Get movie titles
    movies = {}
    for line in open(path + '/u.item',encoding='ISO-8859-1'):
        (id, title) = line.split('|')[0:2]
...
print(r,file=open('455recommend.csv','a'))
